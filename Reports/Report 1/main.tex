...
The team chose the latest stable version, version %TODO: add version info! 
...
Using a generic geometry, 2 motors were configured to the outputs FMU Aux 3 and 4, and 2 servos were configured to the outputs ... % TODO: add outputs (FMU aux, ...)
...
% useful for this: https://docs.px4.io/main/en/concept/architecture.html#update-rates
