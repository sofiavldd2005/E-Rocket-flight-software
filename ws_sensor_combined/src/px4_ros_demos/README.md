...
> This repository contains example nodes for exchanging data and commands between ROS2 and PX4. 
> It is heavily based on the [`px4_ros_com`](https://github.com/PX4/px4_ros_com)
