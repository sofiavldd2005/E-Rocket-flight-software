...
public: 
    MockFlightMode() : 
		...
		flight_mode_set_subscriber_{this->create_subscription<erocket::msg::FlightMode>(
			FLIGHT_MODE_SET_TOPIC, qos_, 
			std::bind(&MockFlightMode::handle_flight_mode_set, this, std::placeholders::_1)
		)},
		flight_mode_get_publisher_{this->create_publisher<erocket::msg::FlightMode>(
...
private:
	...
	rclcpp::Subscription<erocket::msg::FlightMode>::SharedPtr flight_mode_set_subscriber_;
	rclcpp::Publisher<erocket::msg::FlightMode>::SharedPtr flight_mode_get_publisher_;
